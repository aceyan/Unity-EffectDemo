...
public class DebugLog : MonoBehaviour {
   ...
   private void OnGUI()
   {
       ...
       GUI.TextField(new Rect(0, 0, 250 * _uiSize, 70 * _uiSize), "graphicsMemorySize:" + _gms + " systemMemorySize:" + _sms + " processorCount:" + _pc + "\nTotalAllocatedMemory:" + _tam + " ReservedMemory:" + _trm + "\nFPS: " + _fps.ToString("f2") + "\ndpi:" + Screen.dpi);
   }
}
